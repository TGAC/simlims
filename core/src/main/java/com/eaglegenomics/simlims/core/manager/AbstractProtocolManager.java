...
public abstract class AbstractProtocolManager implements ProtocolManager {
	...
	private transient Map<String, Protocol> protocolCache = new HashMap<String, Protocol>();
	private transient Map<String, Activity> activityCache = new HashMap<String, Activity>();
