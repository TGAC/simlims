 ...
 * @since 0.0.1
 */
public class Example1Activity extends AbstractManualActivity {
	protected static final Logger log = LoggerFactory.getLogger(Example1Activity.class);

	public static final String APPEND_STR_KEY = "APPEND_STR";
		...
		for (ActivityData activityData : activitySession.getLockedInputData()) {
			...
			try {
				...
				DataReference outputDataRef = dataReferenceStore
						.create("Hello " + inputData + ", " + appendStr);
				outputDataRef.save();
