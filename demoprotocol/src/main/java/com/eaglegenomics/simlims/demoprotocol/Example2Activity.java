...
import com.eaglegenomics.simlims.core.AbstractAutomatedActivity;
 ...
 * @since 0.0.1
 */
public class Example2Activity extends AbstractAutomatedActivity {
	protected static final Logger log = LoggerFactory.getLogger(Example2Activity.class);
	...
	public void execute(ActivitySession activitySession)
		...
		String appendStr = "(An automated append)";
